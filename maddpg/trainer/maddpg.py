...
class MADDPGAgentTrainer(AgentTrainer):
    def __init__(self, name, model, obs_shape_n, act_space_n, agent_index, args, summary_writer, local_q_func=False):
    ...
    def write_summary(self, episode, agent_episode_reward):
        """
        ...
        """
        summary = tf.Summary()
        summary.value.add(tag='agent_episode_reward', simple_value=agent_episode_reward)
